...
const ModalSubscribe = (props) => {
  ...
  const stageTitle = "Stage Yoga Randonnées";
  ...
  return (
    <Modal show={props.show} onHide={props.handleClose}>
      <Modal.Header closeButton>
        <Modal.Title>
          M'inscrire au stage Yoga et Randonnées du 1,2 Juillet 2023
        </Modal.Title>
      </Modal.Header>
      {isAuthorize ? (
        <Modal.Body>
          <Form>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Label>
                200 € à régler auprès de l'associtaion, nous vous contacterons
            ...
            <Form.Group className="mb-3">
              <Form.Control
                ...
                rows={3}
                placeholder="Merci de préciser la formule hébergement choisie. Avez vous une question ? "
              />
            </Form.Group>
          </Form>
